...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-container">
        ...
        <div class="left-column">
            ...
            <div class="live-filter-box">
                ...
                <input type="text" id="txtLiveFilter" placeholder="Start typing to filter..." class="input-box" onkeyup="filterProducts()" />
            </div>
    ...
    <script>
        function filterProducts() {
            const filter = document.getElementById("txtLiveFilter").value.toLowerCase();
            const table = document.getElementById("<%= gvAvailableProducts.ClientID %>");
