        ...
        <div style="flex:1; min-width:300px;">
            ...
            <div style="background:#F5F5F5; padding:16px; border-radius:8px; border:1px solid #4682B4; margin-bottom: 20px;">
                ...
                <div style="margin-bottom:8px;">
                    <asp:Label runat="server" AssociatedControlID="txtSearch" Text="Product Name" CssClass="lbl" /><br />
                    <asp:TextBox ID="txtSearch" runat="server" CssClass="input-box" Placeholder="Enter product name..." />
                </div>

                <div style="margin-bottom:8px;">
                    <asp:Label runat="server" AssociatedControlID="ddlFilterSupplier" Text="Supplier" CssClass="lbl" /><br />
                    <asp:DropDownList ID="ddlFilterSupplier" runat="server" CssClass="input-box" />
                </div>
